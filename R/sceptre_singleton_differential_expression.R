...
if (!file.exists("RDA_objects/sceptre_singleton_differential_expression")) { dir.create("RDA_objects/sceptre_singleton_differential_expression", recursive = TRUE) }
save.image(paste0("RDA_objects/sceptre_singleton_differential_expression/", snakemake@wildcards$sample, ".rda"))
message("Saved Image")
...
# Specify singleton in Set analysis parameters
